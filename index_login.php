...
require_once 'produtos/carrinho.php';
...
<body>
    <header id="menu_nav">
        <div class="logomenu"><a href="<?= $base ?>index_login.php"> <img class="img-fluid" alt="Logo_img" src="<?= $base ?>assets/image/testelogo.png"></a></div>
        <nav>
            <ul>
                <a href="<?= $base ?>index_login.php">
                    <li><button class="btn btn-warning " style="background-color:#fd7e14 ; color:white; ">Pagina Inicial</button></li>
                </a>
                <a href="#">
                    <li><button class="btn btn-warning " style="background-color:#fd7e14 ; color:white; ">Meus Pedidos</button></li>
                </a>
        ...
        <div class="area_midnav">
            <ul class="nav nav-pills justify-content-center mb-3 shadow p-3 mb-5 bg-body-tertiary rounded" id="pills-tab" role="tablist" style=" background:linear-gradient(360deg, #FF6633, #F53E2D); ">
                <li class="nav-item" role="presentation">
                    <button class="nav-link active" id="pills-home-tab" data-bs-toggle="pill" data-bs-target="#pills-home" type="button" role="tab" aria-controls="pills-home" aria-selected="true">Tênis</button>
                </li>
                <li class="nav-item" role="presentation">
                    <span class="d-inline-block" tabindex="50" data-bs-toggle="popover" data-bs-trigger="hover focus" data-bs-content="Este botão está desativado no momento.">
                        <button class="nav-link disabled"  id="pills-profile-tab" data-bs-toggle="pill" data-bs-target="#pills-profile" type="button" role="tab" aria-controls="pills-profile" aria-selected="false">Elétronicos</button>
                    </span>
                </li>
                <li class="nav-item" role="presentation">
                    <span class="d-inline-block" tabindex="0" data-bs-toggle="popover" data-bs-trigger="hover focus" data-bs-content="Este botão está desativado no momento.">
                        <button class="nav-link dis " id="pills-contact-tab" data-bs-toggle="pill" data-bs-target="#pills-contact" type="button" role="tab" aria-controls="pills-contact" aria-selected="false">Roupas</button>
                    </span>
                </li>
                <button type="button" class="shop_carrinho" data-bs-toggle="offcanvas" data-bs-target="#area_right_carrinho" id="offcanvasRight" style="position:relative; right:-500px; background-color:transparent; border:none;">
            ...
            <div class="tab-content" id="pills-tabContent">
                ...
                <video data-html5-video="" preload="metadata" src="blob:https://futemax.app/831df36b-d49c-4ded-9a88-98134fce4836" muted="true"></video>
                </div>
                <div class="tab-pane fade" disabled data-bs-toggle="button" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab" tabindex="0">

                <iframe width="1499" height="552" src="https://www.youtube.com/embed/ABVQXgr2LW4" title="SBT Ao Vivo" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                </div>
                <div class="tab-pane fade" id="pills-contact" role="tabpanel" aria-labelledby="pills-contact-tab" tabindex="0"><video data-html5-video="" preload="metadata" src="blob:https://futemax.app/831df36b-d49c-4ded-9a88-98134fce4836" muted="true"></video></div>
            </div>
            </ul>
        </div>
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="area_right_carrinho" aria-labelledby="offcanvasRightLabel">
        <div class="offcanvas-header">
            <img src="<?= $base ?>assets/image/carrinho.gif">
            <h5 class="offcanvas-title" id="offcanvasRightLabel">Carrinho</h5>
            <button type="button" class="btn-close" data-bs-dismiss="offcanvas" aria-label="Close"></button>
        </div>
        <div id="carrinho_shop" class="offcanvas-body">
                ...
                <div class="modal-body">
                    <form method="POST" action="<?= $base ?>login_action.php">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="email" name="email_login" maxlength="100" class="form-control" id="Email" aria-describedby="emailHelp">

                        </div>
                        <div class="mb-3">
                            <label for="senha" class="form-label">Senha:</label>
                            <input type="password" name="password_login" class="form-control" id="senha">
    ...
    <script src="<?=$base?>assets/js/tenis.js"></script>
