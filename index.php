    ...
    <header id="menu_nav">
        ...
        <nav>
            <ul>
                ...
                <li><button type="button" style="color:white;" class="btn btn-outline-warning"><a href="<?=$base?>signup.php" rel="noopener noreferrer">Cadastro</a> </button></li>
            </ul>
        </nav>
    </header>
            ...
            <li class="nav-item" role="presentation">
                ...
                <li class="nav-item" role="presentation">
                    <span class="d-inline-block" tabindex="0" data-bs-toggle="popover" data-bs-trigger="hover focus" data-bs-content="Este botão está desativado no momento.">
                        <button class="nav-link dis disabled" id="pills-contact-tab" data-bs-toggle="pill" data-bs-target="#pills-contact" type="button" role="tab" aria-controls="pills-contact" aria-selected="false">Roupas</button>
                    </span>
                </li>
                ...
                <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab" tabindex="0">
                    ...
                    foreach($produtos as $key => $value) {
                     ?>
                        ...
                        <img id="img_shoes" src="assets/image/<?=$value['img'] ?>" class="card-img-top img-fluid" alt="...">
                        <div class="card-body">
                        <h5 class="card-title"><?=$value['nome']?></h5>
                        <p> Tamanho: <?=$value['tamanho']?></p>
                        <p class="card-text"><?=$value['desc']?></p>
                        <p>Valor: R$<?=$value['valor']?></p>
                        <button type="button" class="btn btn-lg btn-primary" data-bs-toggle="popover" data-bs-title="Negado!" data-bs-content="Você só pode adicionar ao carrinho se estiver logado !!">Adicionar ao carrinho</button>
...
<!----------------------------      Mensagem carrinho       -----------------------------  -->
    ...
    <div class="toast-container position-fixed bottom-0 end-0 p-3">
        <div id="carrinho_error" class="toast" role="alert" aria-live="assertive" aria-atomic="true">
            <div class="toast-header">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-x-circle-fill rounded me-2" viewBox="0 0 16 16">
                    <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zM5.354 4.646a.5.5 0 1 0-.708.708L7.293 8l-2.647 2.646a.5.5 0 0 0 .708.708L8 8.707l2.646 2.647a.5.5 0 0 0 .708-.708L8.707 8l2.647-2.646a.5.5 0 0 0-.708-.708L8 7.293 5.354 4.646z" />
                </svg>
            ...
            <div class="toast-body">
                Você só pode adicionar ao carrinho quando está logado !
            </div>
        </div>
    </div>
